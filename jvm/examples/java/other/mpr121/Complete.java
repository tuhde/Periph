...
public class Complete {
    public static void main(String[] args) throws Exception {
        try (var connection = new I2CConnection(1, 0x5A)) {            // Open I2C connection, (bus=1, address=0x5A) → I2CConnection
            ...
            mpr.configureAutoconfig(3300, 0, false, true, true);       // Configure autoconfig, (vdd_mv=3300, retry=0, scts=false, are=true, ace=true) → void
            ...
            for (int i = 0; i < 10; i++) {
                ...
                System.out.printf("t=0x%03X f0=%d b0=%d oor=0x%04X pt=%s%n", t, f0, b0, oor, pt);
            }
