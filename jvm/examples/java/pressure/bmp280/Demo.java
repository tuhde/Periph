...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        try (var connection = new I2CConnection(1, 0x76)) {       // open I²C bus 1, device 0x76 (SDO low), (bus, address=0x76) → I2CConnection
            var sensor = new Bmp280Full(connection);                     // construct driver, verifies chip ID, reads calibration, (connection) → Bmp280Full
