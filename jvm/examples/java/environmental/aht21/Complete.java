...
public class Complete {
    public static void main(String[] args) throws Exception {
        try (var transport = new I2CTransport(1, 0x38)) {            // open I²C bus 1, device 0x38, (bus, address) → I2CTransport
            ...
            System.out.println("Busy: " + aht.isBusy());                  // check busy status, () → boolean
            ...
            System.out.printf("Humidity: %.2f %%RH%n", h);
            ...
            System.out.printf("T=%.2f °C  H=%.2f %%RH  CRC: %s%n",
                    rc[0], rc[1], rc[2] > 0.5 ? "OK" : "FAIL");
