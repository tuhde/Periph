...
public class Complete {
    public static void main(String[] args) throws Exception {
        try (var transport = new I2CTransport(1, 0x20)) {             // open I²C bus 1, device 0x20, (bus, address) → I2CTransport
            var chip = new Pcf8575Full(transport);                      // construct full driver, (transport) → Pcf8575Full
            ...
            int changed = chip.clearInterrupt();                        // read and return 16-bit changed bitmask, () → int
