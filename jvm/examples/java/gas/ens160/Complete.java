...
public class Complete {
    public static void main(String[] args) throws Exception {
        try (var transport = new I2CTransport(1, 0x52)) {        // open I²C bus 1, device 0x52, (bus, address=0x52) → I2CTransport
            ...
            System.out.printf("Firmware: %d.%d.%d%n", fw[0], fw[1], fw[2]);
            ...
            System.out.printf("TVOC=%.0f ppb, eCO2=%.0f ppm, AQI=%d%n", tvoc, eco2, aqi);
            System.out.printf("Ethanol=%.0f ppb, R1=%.0f Ohm, R4=%.0f Ohm%n", ethanol, r1, r4);
            System.out.printf("Actual T=%.1f C, RH=%.1f %%%n", actuals[0], actuals[1]);
