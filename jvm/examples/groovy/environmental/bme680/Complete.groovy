...
try {
    def sensor = new Bme680Full(connection)                      // construct driver, verifies chip ID and loads calibration, (connection) → Bme680Full
    ...
    printf("gas resistance: %.0f Ω%n", g)
    ...
    printf("readAll: %.2f °C  %.2f hPa  %.1f %%RH  %.0f Ω%n",
    ...
    sensor.setAmbientTemperature(25.0d)                         // override ambient temperature for heater calc, (tempC °C) → void
