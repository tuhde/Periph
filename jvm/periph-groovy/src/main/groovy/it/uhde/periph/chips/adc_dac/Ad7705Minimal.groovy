 ...
 * uses the chip's two-phase register-access protocol and polls the 0/DRDY bit
 * of the Communication Register over SPI rather than requiring a dedicated
 * DRDY GPIO.
 *
...
class Ad7705Minimal {
     ...
     */
    Ad7705Minimal(Connection connection, float vref, int mclkHz) {
