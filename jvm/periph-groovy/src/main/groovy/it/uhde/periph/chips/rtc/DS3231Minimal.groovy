 ...
 * 0x68.
 *
 * This driver always operates the chip's {@code HOURS} registers in 24-hour
 * mode; the native 12-hour/AM-PM encoding is never written or exposed. The
 * {@code DAY} (day-of-week) register is a free-running 1-7 counter with no
...
class DS3231Minimal {
     ...
     * the CONTROL register (the DS3231 has no WHO_AM_I register); makes no
     * register writes.
     *
    ...
    DateTime getDatetime() {
        ...
        return new DateTime(year: year, month: month, day: day, weekday: weekday, hour: hour, minute: minute, second: second)
    }
