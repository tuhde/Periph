...
/**
 * WS2812B full interface — extends the shared {@link NeoPixelRGBFull} Java
 * base with GRB wire order and WS2812B's default reset length.
 *
...
class WS2812BFull extends NeoPixelRGBFull {
     ...
     */
    WS2812BFull(Connection connection, int n) {
