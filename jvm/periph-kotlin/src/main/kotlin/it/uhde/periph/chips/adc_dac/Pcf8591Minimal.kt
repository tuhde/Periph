 ...
 */
open class Pcf8591Minimal(protected val connection: Connection) {
    ...
    fun readChannel(channel: Int): Int {
        ...
        connection.write(byteArrayOf((control or (ch and 0x03)).toByte()))
    ...
    fun readAll(): IntArray {
        connection.write(byteArrayOf((control or 0x04).toByte()))
        val buf = connection.read(NUM_CHANNELS + 1)
        return intArrayOf(
