...
/**
 * MPU-9250 — 9-axis MotionTracking device (accelerometer + gyroscope), minimal driver.
 *
 ...
 */
open class MPU9250Minimal @JvmOverloads constructor(
    ...
    init {
        ...
        if (who != WHO_AM_I_VALUE) {
            throw java.io.IOException("MPU9250 WHO_AM_I: expected 0x${Integer.toHexString(WHO_AM_I_VALUE)}, got 0x${Integer.toHexString(who)}")
        }
