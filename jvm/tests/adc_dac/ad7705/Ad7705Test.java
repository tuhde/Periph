...
public class Ad7705Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var connection = new SPIConnection(bus, dev, 3, 1_000_000)) {
            var adcMin = new Ad7705Minimal(connection, 2.5f, Ad7705Minimal.MCLK_2_4576MHZ);
            var adc = new Ad7705Full(connection, 2.5f, Ad7705Full.MCLK_2_4576MHZ);
