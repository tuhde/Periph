...
public class As5600Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var transport = new I2CTransport(bus, addr)) {
            ...
            checkTrue("angle() in range 0–360", angle >= 0.0 && angle < 360.0);
            ...
            boolean mh = as5600.isMagnetTooStrong();
            checkTrue("isMagnetTooStrong() accepted", true);

            boolean ml = as5600.isMagnetTooWeak();
            ...
            checkTrue("rawAngleDegrees() in range 0–360", rawDeg >= 0.0 && rawDeg < 360.0);
            ...
            checkTrue("angle() after configure() in range", angle2 >= 0.0 && angle2 < 360.0);
