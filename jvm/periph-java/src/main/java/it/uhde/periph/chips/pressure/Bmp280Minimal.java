...
public class Bmp280Minimal {
    ...
    protected int ctrlMeas = 0x25;   // osrs_t=×1, osrs_p=×1, mode=forced placeholder
    ...
    protected void readCalibration() throws IOException {
        ...
        digT2 = buf.getShort();             // int16
        digT3 = buf.getShort();             // int16
        digP1 = buf.getShort() & 0xFFFF;   // uint16
        digP2 = buf.getShort();             // int16
        digP3 = buf.getShort();             // int16
        digP4 = buf.getShort();             // int16
        digP5 = buf.getShort();             // int16
        digP6 = buf.getShort();             // int16
        digP7 = buf.getShort();             // int16
        digP8 = buf.getShort();             // int16
        digP9 = buf.getShort();             // int16
    }
    ...
    protected double compensatePressure(int adcP) {
        ...
        if (var1 == 0) return 0.0;   // avoid division by zero
