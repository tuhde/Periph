 ...
 */
public class Eeprom24Aa02UidFull extends Eeprom24Aa02UidMinimal {
     ...
     * start of the same page (FIFO overwrite) — use
     * {@link #write(int, byte[])} to handle boundaries automatically.
     *
     ...
     * @throws IOException on I²C error
     */
    public int readManufacturerCode() throws IOException {
        return readByte(ADDR_MFR_CODE);
    }
     ...
     * @throws IOException on I²C error
     */
    public int readDeviceCode() throws IOException {
        return readByte(ADDR_DEV_CODE);
    }
}
