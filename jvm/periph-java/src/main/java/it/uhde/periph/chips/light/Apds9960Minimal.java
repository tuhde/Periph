...
public class Apds9960Minimal {
     ...
     * @throws IOException on I²C error
     */
    public int colorClear() throws IOException {
        return readReg16LE(REG_CDATAL);
    }
     ...
     *
     * <p>Reading CDATAL at 0x94 atomically latches all eight bytes 0x94-0x9B.
     *
