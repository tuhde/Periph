 ...
 *
 * <p>Reads calibrated voltage from Channel 1 with sensible defaults. The
 * driver uses the chip's two-phase register-access protocol (Communication
 * Register write followed by the data transfer within one CS assertion) and
 * polls the {@code 0/DRDY} bit of the Communication Register over SPI
 * rather than requiring a dedicated DRDY GPIO.
 *
 * <p>Sensible defaults baked in at construction:
 * <ul>
 *   <li>Channel 1 (AIN1) selected.</li>
 ...
 * to the 24-bit calibration coefficients are in {@link Ad7705Full}.
 *
...
public class Ad7705Minimal {
     ...
     */
    public Ad7705Minimal(Connection connection, float vref, int mclkHz) throws IOException {
