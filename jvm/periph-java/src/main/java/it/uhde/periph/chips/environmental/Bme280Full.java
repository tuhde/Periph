 ...
 * {@link #T_SB_0_5_MS} … {@link #T_SB_1000_MS}, {@link #T_SB_10_MS}, {@link #T_SB_20_MS}
 * — note that codes 6 and 7 mean <b>10 ms / 20 ms</b> on the BME280, not
 * 2000 ms / 4000 ms as on the BMP280.
 *
 * <h2>Status flags</h2>
 * {@link #STATUS_MEASURING}, {@link #STATUS_IM_UPDATE}
 */
public class Bme280Full extends Bme280Minimal {
    ...
    public static final int T_SB_10_MS    = 6;
    public static final int T_SB_20_MS    = 7;
     ...
     */
    public Bme280Full(Transport transport) throws IOException {
        super(transport);
    }
     ...
     * @throws IOException on I²C error, wrong chip ID, or invalid calibration
     */
    public Bme280Full(Transport transport, int addr) throws IOException {
     ...
     */
    public void configure(int osrsT, int osrsP, int osrsH, int mode, int filter, int tSb) throws IOException {
        ctrlHum  = osrsH & 0x07;
     ...
     *
     * <p>Preserves the standby time and reserved bits in the config register.
     *
     ...
     *
     * @param tSb standby time (0–7, use {@code T_SB_*}). Note that on the
     *            BME280 codes 6 and 7 mean 10 ms and 20 ms, not 2000 ms and
     *            4000 ms.
     * @throws IOException on I²C error
     */
     ...
     * @throws IOException on I²C error
     */
    public double dewPoint() throws IOException {
     ...
     * previously configured ctrl_hum / config / ctrl_meas register values.
     *
     * @throws IOException on I²C error
     */
    public void reset() throws IOException {
        transport.write(new byte[]{(byte) REG_SOFT_RST, (byte) RESET_CMD});
        try {
            Thread.sleep(2);
