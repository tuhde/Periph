 ...
 *
 * <p>DHT11 is a low-cost combined temperature and humidity sensor with factory-calibrated
 ...
 *
 * <p>Note: This driver requires a GPIO-based transport (e.g. DHTxxTransport) that
...
public class DHT11Minimal {
    ...
    public DHT11Minimal(Transport transport) {
