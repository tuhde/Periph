 ...
 *
 * <p>Extends {@link Ad7705Minimal} with per-channel configuration, all eight
 * PGA gains, unipolar/bipolar selection, buffered/unbuffered analog inputs,
 * all four output rates within the {@code mclkHz} family, self- and
 * system-calibration, direct access to the 24-bit calibration coefficients,
 * standby/wakeup power control, and an optional hardware reset pin.
 */
public class Ad7705Full extends Ad7705Minimal {
     ...
     */
    public Ad7705Full(Connection connection, float vref, int mclkHz, OutputPin resetPin) throws IOException {
        super(connection, vref, mclkHz);
        this.resetPin = resetPin;
    }

    /**
     * Construct and initialise the AD7705 without a hardware reset pin.
     *
     * @param connection SPI connection bound to the device.
     * @param vref       reference voltage in V.
     * @param mclkHz     master clock frequency in Hz.
     * @throws IOException on SPI error.
     */
    public Ad7705Full(Connection connection, float vref, int mclkHz) throws IOException {
