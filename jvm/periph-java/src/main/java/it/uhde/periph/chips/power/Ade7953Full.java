 ...
 */
public class Ade7953Full extends Ade7953Minimal {

    public Ade7953Full(Connection connection, double voltageGain, double currentGain) throws IOException {
    ...
    public void configureOvercurrent(double threshold) throws IOException {
