...
adc = AD7706Full(conn, vref=2.5, mclk_hz=2_457_600, reset_pin=reset)                    # Create AD7706 driver, (connection, vref=2.5 V, mclk_hz=2_457_600 Hz, reset_pin=None) → None
...
adc.configure(channel=3, gain=8, bipolar=True, buffered=True, output_rate_hz=60)        # Configure channel 3, (channel=1, gain=1, bipolar=True, buffered=False, output_rate_hz=50) → None
...
v3 = adc.read_voltage(channel=3)                                                        # Read voltage, (channel=3) → float V
print("ch1 raw=", raw1, "ch1 v=", v1, "ch2 v=", v2, "ch3 v=", v3)
