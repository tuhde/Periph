...
# Humidity compensation worked example cross-checked against the Bosch
# reference C source code (rev 1.1). Calibration values are typical for a
# real BME280 at room temperature; adc_H = 29000 yields a value near 45 %RH.
bme._dig_H1 = 75
bme._dig_H2 = 362
bme._dig_H3 = 0
bme._dig_H4 = 341
bme._dig_H5 = 50
bme._dig_H6 = 30
bme._t_fine = 128422  # result of _compensate_temp(519888) with the BMP280 sample calibration
