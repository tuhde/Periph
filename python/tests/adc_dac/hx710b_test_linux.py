...
DOUT   = int(os.environ.get('HX710B_DOUT',   '5'))
PD_SCK = int(os.environ.get('HX710B_PD_SCK', '6'))
...
# check captures this call - see conformance/adc_dac/hx710b_conformance.py).
chip.power_down()
time.sleep(0.001)
chip.power_up()
...
supp_raw = chip.read_supply_diff_raw()
time.sleep(0.01)
check_true('read_supply_diff_raw returns int', isinstance(supp_raw, int))
check_true('read_supply_diff_raw in 24-bit signed range', -8388608 <= supp_raw <= 8388607)
