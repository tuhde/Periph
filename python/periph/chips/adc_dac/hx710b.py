class HX710BMinimal:
    """HX710B 24-bit ADC — minimal interface.
    ...
    def __init__(self, connection):
        """Initialize HX710BMinimal and discard the first post-power-up conversion.
...
class HX710BFull(HX710BMinimal):
    """HX710B full interface — extends HX710BMinimal with rate selection, tare,
    ...
    def __init__(self, connection):
        """Initialize HX710BFull with default 10 SPS rate, offset 0, and scale 1.0.
    ...
    def read_supply_diff_raw(self):
        ...
        Returns:
            int: Signed 24-bit raw ADC code from the supply-difference channel.
        """
