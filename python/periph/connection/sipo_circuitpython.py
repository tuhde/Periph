class SiPoConnection:
    """SiPo (serial-in/parallel-out shift register) connection for CircuitPython.
    ...
    Connection base — it carries its own enabled flag and en_pin instead.
    ...
    def __init__(self, spi, rck, srclr=None, g=None, baudrate=1_000_000, en_pin=None):
        self._spi = spi
        self._rck = rck
        self._srclr = srclr
        self._g = g
