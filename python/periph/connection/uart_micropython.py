...
class UARTConnection(Connection):
    """UART connection for MicroPython (wraps machine.UART).

    The caller constructs and configures the UART instance before passing it
    to this connection. When de_pin is provided the connection operates in
    ...
    Args:
        ...
        baudrate: Baud rate of the UART; used to calculate the TX-drain delay
            ...
            with.
        de_pin: machine.Pin for RS-485 direction-enable (active high). Pass
