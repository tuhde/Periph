...
async function main() {
    ...
    const bme = new BME280Minimal(connection);
    ...
    const bmeFull = new BME280Full(connection);
    ...
    await bmeFull.setOversampling(BME280Full.OSRS_X4, BME280Full.OSRS_X2, BME280Full.OSRS_X1);
