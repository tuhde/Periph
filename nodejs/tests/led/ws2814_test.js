...
const { WS2814Minimal, WS2814Full } = require('../../packages/periph/src/chips/led/ws2814');
...
async function main() {
    ...
    // --- WS2814Minimal ---
    const strip = new WS2814Minimal(connection, 8);
