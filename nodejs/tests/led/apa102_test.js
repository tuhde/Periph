...
const { APA102Minimal, APA102Full } = require('../../packages/periph/src/chips/led/apa102');
...
async function main() {
    const connection = new SPIConnection(SPI_BUS, SPI_DEVICE, { mode: 0, maxSpeedHz: 1_000_000 });

    // --- APA102Minimal ---
    const strip = new APA102Minimal(connection, 8);
    ...
    // --- APA102Full ---
    const full = new APA102Full(connection, 8);
