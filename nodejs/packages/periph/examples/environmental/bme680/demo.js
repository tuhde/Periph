...
(async () => {
    ...
    await bme.configure(BME680Full.OSRS_X2, BME680Full.OSRS_X16, BME680Full.OSRS_X1, BME680Full.MODE_FORCED, BME680Full.FILTER_15);  // Configure chip, (osrsT=×2, osrsP=×16, osrsH=×1, mode=forced, filter=15) → undefined
    await bme.setHeater(320, 150);                        // Configure heater profile 0, (tempC=320, durationMs=150) → undefined
