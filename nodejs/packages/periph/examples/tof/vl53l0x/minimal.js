...
const { VL53L0XMinimal } = require('periph/src/chips/tof/vl53l0x');

const sleep = (ms) => new Promise((r) => setTimeout(r, ms));

(async () => {
    const bus = parseInt(process.env.I2C_BUS || '1', 10);
    const connection = new I2CConnection(bus, VL53L0XMinimal.I2C_ADDRESS);
    const sensor = new VL53L0XMinimal(connection);                                 // Create VL53L0X driver, (connection)
