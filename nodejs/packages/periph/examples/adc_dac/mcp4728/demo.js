...
(async () => {
    ...
    await dac.set_all(calibration);                // Update all four channels simultaneously, (fractions[4]) → None
    ...
    for (let n = 0; n <= 16; n++) {
        const f = n * STEP;
        await dac.set_all([f, f, f, f]);           // Update all four channels simultaneously, (fractions[4]) → None
    ...
    await dac.set_all([0.0, 0.0, 0.0, 0.0]);       // Update all four channels simultaneously, (fractions[4]) → None
