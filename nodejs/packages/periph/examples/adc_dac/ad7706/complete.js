...
(async () => {
    ...
    await adc.configure(3, 8, true, true, 60);                                                        // Configure channel 3, (channel=3, gain=8, bipolar=true, buffered=true, output_rate_hz=60) → None
    ...
    const v3 = await adc.readVoltageChannel(3);                                                        // Read voltage, (channel=3) → float V
    console.log('ch1 raw=' + raw1 + ' ch1 v=' + v1.toFixed(4) + ' ch2 v=' + v2.toFixed(4) + ' ch3 v=' + v3.toFixed(4));
