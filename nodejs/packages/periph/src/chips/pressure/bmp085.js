 ...
 *
 * Provides calibrated temperature (°C) and pressure (Pa) with no configuration
 ...
 * rather than a synchronous throw from `new BMP085Minimal(...)`. Callers
...
/**
 * BMP085 full interface — extends BMP085Minimal with OSS control and altitude helpers.
 *
 * OSS constants:
 * - BMP085Full.OSS_ULP — Ultra Low Power (oss=0, 4.5 ms)
 * - BMP085Full.OSS_STANDARD — Standard (oss=1, 7.5 ms)
...
class BMP085Full extends BMP085Minimal {
     ...
     * @param {number} [seaLevelPa=101325.0] - Reference sea-level pressure in Pa.
     ...
     * @returns {Promise<number>} Sea-level pressure in Pa.
     */
...
module.exports = { BMP085Minimal, BMP085Full };