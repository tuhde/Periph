...
/**
 * AD7706 3-channel, 16-bit sigma-delta ADC driver (SPI).
 *
 ...
 * read/write direction + channel), then transfer the data bytes in a
...
function calibrationSetup(mode, gain, bipolar, buffered) {
    return mode | GAIN_BITS[GAIN_TO_IDX[gain]] | (bipolar ? BIPOLAR : UNIPOLAR) | (buffered ? BUFFERED : UNBUFFERED) | FSYNC_RUN;
}
...
class AD7706Full extends AD7706Minimal {
     ...
     *
     * @param {number} channel - 1, 2, or 3 (AIN1, AIN2, AIN3 — all relative to COMMON).
...
module.exports = { AD7706Minimal, AD7706Full };
