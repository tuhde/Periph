 ...
 */
class HX710BFull extends HX710BMinimal {
    /**
     * @param {import('../../connection/hx711').HX711Connection} connection - Configured HX711 connection.
     */
    constructor(connection) {
     ...
     *
     * @returns {number} Signed 24-bit raw ADC code from the supply-difference channel.
     */
    readSupplyDiffRaw() {
...
module.exports = { HX710BMinimal, HX710BFull };
