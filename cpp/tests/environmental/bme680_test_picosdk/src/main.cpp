...
int main(void) {
    ...
    check_near(bme.temperature(), -40.0f, 85.0f, "temperature range");
    check_near(bme.humidity(),     0.0f, 100.0f, "humidity range");
    check_near(bme.pressure(),   300.0f, 1100.0f, "pressure range");
    check_near(bme.gas_resistance(), 0.0f, 1.0e6f, "gas resistance range");
