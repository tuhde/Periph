// Auto-generated ESP-IDF test for INA219.
// Mirrors the Zephyr test for INA219; prints PASS/FAIL and exits.
...
extern "C" void app_main(void) {
    ...
    INA219Full inst(connection);  // Create INA219 driver
    float v = inst.voltage();
    check_near(v, 0.0f, 32.0f, "voltage range");
    float i = inst.current();
    check_near(i, -10.0f, 10.0f, "current range");
    float p = inst.power();
    check_near(p, 0.0f, 5.0f, "power range");
