// Auto-generated ESP-IDF test for PCF8575.
// Mirrors the Zephyr test for PCF8575; prints PASS/FAIL and exits.
...
extern "C" void app_main(void) {
    ...
    PCF8575Full inst(connection, 0x20);  // Create PCF8575 driver
    inst.write_port(0, 0x55);
    inst.write_port(1, 0xAA);
    (void)inst.read_port(0);
    (void)inst.read_port(1);
    check_true(true, "pcf8575 comm ok");
