// Auto-generated ESP-IDF test for AS5600.
// Mirrors the Zephyr test for AS5600; prints PASS/FAIL and exits.
...
extern "C" void app_main(void) {
    ...
    uint16_t r = inst.raw_angle();
    check_true(r <= 4095, "raw_angle in range");
    check_true(!inst.is_magnet_too_weak(), "magnet not too weak");
    check_true(!inst.is_magnet_too_strong(), "magnet not too strong");
