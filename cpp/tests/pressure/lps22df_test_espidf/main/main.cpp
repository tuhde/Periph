...
extern "C" void app_main(void) {
    ...
    check_near(p, 26000.0f, 126000.0f, "pressure_range");
    inst.configure(3, 0, true, 1, true);
    float p2 = inst.pressure();
    check_near(p2, 26000.0f, 126000.0f, "configure_then_read");
