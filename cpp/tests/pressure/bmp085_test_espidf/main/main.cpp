// Auto-generated ESP-IDF test for BMP085.
// Mirrors the Zephyr test for BMP085; prints PASS/FAIL and exits.
...
extern "C" void app_main(void) {
    ...
    BMP085Full inst(connection);  // Create BMP085 driver
    check_eq_u8(inst.chip_id(), 0x55, "chip_id 0x55");
    float t = inst.temperature();
    check_near(t, -40.0f, 85.0f, "temperature range");
    float p = inst.pressure();
    check_near(p, 30000.0f, 110000.0f, "pressure range");
