// Auto-generated ESP-IDF test for 24AA02UID.
// Mirrors the Zephyr test for 24AA02UID; prints PASS/FAIL and exits.
...
extern "C" void app_main(void) {
    ...
    EEPROM24AA02UIDFull inst(connection);  // Create 24AA02UID driver
    check_true(true, "smoke test");
