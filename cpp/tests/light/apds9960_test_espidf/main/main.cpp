// Auto-generated ESP-IDF test for APDS9960.
// Mirrors the Zephyr test for APDS9960; prints PASS/FAIL and exits.
...
extern "C" void app_main(void) {
    ...
    dev_cfg.device_address = 0x39;
    dev_cfg.scl_speed_hz = 400000;
    i2c_master_dev_handle_t dev;
    i2c_master_bus_add_device(bus, &dev_cfg, &dev);

    I2CConnectionESPIDF connection(dev);
    APDS9960Full inst(connection);  // Create APDS9960 driver
    ...
    (void)p;
    inst.als_threshold(100, 60000);
    inst.proximity_threshold(10, 200);
    inst.set_persistence(0, 1);
    inst.clear_all_interrupts();
