// Auto-generated ESP-IDF example for BMP280 (Minimal).
// Mirrors the Arduino BMP280_Minimal example using the
...
extern "C" void app_main(void) {
    ...
    BMP280Minimal chip(transport, false);  // Create BMP280 driver
    float t, p;
    while (1) {
