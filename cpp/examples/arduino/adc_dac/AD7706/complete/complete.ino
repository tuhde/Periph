...
AD7706Full adc(connection, 2.5, AD7706Minimal::MCLK_2_4576MHZ, &reset_pin);
                                                                     // Construct and initialise the AD7706, (connection, vref=2.5 V, mclk_hz=2_457_600 Hz, reset_pin=&reset_pin) → AD7706Full
...
void setup() {
    ...
    Serial.print(" ch2 v="); Serial.print(v2);
    Serial.print(" ch3 v="); Serial.println(v3);
