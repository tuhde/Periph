// Auto-generated ESP-IDF example for PCF8574 (Demo).
// Mirrors the Arduino PCF8574_Demo example using the
...
extern "C" void app_main(void) {
    ...
    uint8_t val;
    uint8_t mask;
    // --- Read and write the 8-bit port, watching changes ---
    // PCF8574 is quasi-bidirectional: 1 = input (weak pull-up), 0 = drive low. Writes are atomic via the shadow register.
