// Auto-generated ESP-IDF example for PCF8575 (Demo).
// Mirrors the Arduino PCF8575_Demo example using the
...
extern "C" void app_main(void) {
    ...
    uint8_t val;
    uint8_t mask;
    // --- Read and write both 8-bit ports, watching changes ---
    // PCF8575 is quasi-bidirectional: 1 = input, 0 = drive low.
