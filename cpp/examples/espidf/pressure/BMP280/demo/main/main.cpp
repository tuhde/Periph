// Auto-generated ESP-IDF example for BMP280 (Demo).
// Mirrors the Arduino BMP280_Demo example using the
...
extern "C" void app_main(void) {
    ...
    float t, p, alt, slp;
    uint8_t cid, st;
    // --- Log T/P with averaging ---
    // BMP280 supports 4x averaging and 4 IIR filter settings; 4x averaging + 4x IIR suppresses the worst switching noise on a 3V3 rail.
