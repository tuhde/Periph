// Auto-generated ESP-IDF example for BMP085 (Complete).
// Mirrors the Arduino BMP085_Complete example using the
...
extern "C" void app_main(void) {
    ...
    chip.set_oversampling(BMP085Full::OSS_HIGH_RES);  // Set OSS, (oss 0-3) → void
    ...
    chip.sea_level_pressure(100.0f);                  // Compute sea-level pressure, (altitude_m) → float Pa
