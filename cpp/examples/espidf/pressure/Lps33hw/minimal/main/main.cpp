// Auto-generated ESP-IDF example for LPS33HW (Minimal).
// Mirrors the Arduino LPS33HW_Minimal example using the
...
extern "C" void app_main(void) {
    ...
    LPS33HWMinimal chip(connection);  // Create LPS33HW driver, (connection)
    while (1) {
