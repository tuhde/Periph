// Auto-generated ESP-IDF example for WS2814 (Complete).
// Mirrors the Arduino WS2814_Complete example using the
...
extern "C" void app_main(void) {
    ...
    WS2814Full chip(connection, 8);  // Create WS2814 driver
