// Auto-generated ESP-IDF example for WS2814 (Minimal).
// Mirrors the Arduino WS2814_Minimal example using the
...
extern "C" void app_main(void) {
    ...
    WS2814Minimal chip(connection, 8);  // Create WS2814 driver
    while (1) {
