// Auto-generated ESP-IDF example for INA219 (Demo).
// Mirrors the Arduino INA219_Demo example using the
...
extern "C" void app_main(void) {
    ...
    float v, i, p;
    bool cr, ov;
    // --- Stream V / I / P to stdout ---
    // Driver runs in continuous shunt+bus mode; 12-bit ADC, ~530 us per conversion.
