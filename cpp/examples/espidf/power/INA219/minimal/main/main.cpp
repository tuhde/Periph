// Auto-generated ESP-IDF example for INA219 (Minimal).
// Mirrors the Arduino INA219_Minimal example using the
...
extern "C" void app_main(void) {
    ...
    INA219Minimal chip(connection);  // Create INA219 driver
    float v, i, p;
    bool cr, ov;
    while (1) {
