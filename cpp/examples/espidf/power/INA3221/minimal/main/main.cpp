// Auto-generated ESP-IDF example for INA3221 (Minimal).
// Mirrors the Arduino INA3221_Minimal example using the
...
extern "C" void app_main(void) {
    ...
    INA3221Minimal chip(connection);  // Create INA3221 driver
    float v, sv, i, p;
    bool pvf, cr;
