// Auto-generated ESP-IDF example for Mpu6050 (Demo).
// Mirrors the Arduino Mpu6050_Demo example using the
...
extern "C" void app_main(void) {
    ...
    MPU6050Full chip(transport);  // Create Mpu6050 driver
    ...
    bool ready;
    // --- Read accel / gyro / temperature in a loop ---
    // MPU-6050 is 6-DoF. Default FS: +/-2 g / +/-250 dps.
