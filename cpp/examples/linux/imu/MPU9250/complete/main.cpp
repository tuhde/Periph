...
int main() {
    ...
    MPU9250Full imu(connection, magConnection);                          // Create MPU9250 driver, (connection, magConnection)
    ...
    printf("t=%.2f  mag=%.1f,%.1f,%.1f  ready=%d\n", t, mx, my, mz, ready);
    (void)ax; (void)ay; (void)az; (void)gx; (void)gy; (void)gz;
    (void)rax; (void)ray; (void)raz; (void)rgx; (void)rgy; (void)rgz; (void)rmx; (void)rmy; (void)rmz;
    (void)count; (void)read;
    return 0;
}
