...
int main() {
    ...
    gpiod_line_request_input(dout,   "hx710a");
    gpiod_line_request_output(pd_sck, "hx710a", 0);
    HX711ConnectionLinux connection(dout, pd_sck);

    HX710AMinimal<HX711ConnectionLinux> chip(connection);                   // Create HX710A driver, (connection)
