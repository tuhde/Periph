...
/** @brief NeoPixel (WS2812B-compatible) transport for the Raspberry Pi Pico SDK.
 *
 ...
 */
class NeoPixelTransportPicoSDK : public Transport {
public:
    NeoPixelTransportPicoSDK(spi_inst_t* spi) : _spi(spi) {}
