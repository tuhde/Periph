...
/** @brief NeoPixel (WS2812B-compatible) transport for ESP-IDF.
 *
 ...
 */
class NeoPixelTransportESPIDF : public Transport {
public:
     ...
     */
    NeoPixelTransportESPIDF(spi_device_handle_t dev)
        : _mode(Mode::SPI), _spi(dev), _rmt_chan(nullptr), _encoder(nullptr) {}
     ...
     */
    NeoPixelTransportESPIDF(rmt_channel_handle_t rmt_chan,
                            rmt_encoder_handle_t encoder)
        : _mode(Mode::RMT), _spi(nullptr), _rmt_chan(rmt_chan), _encoder(encoder) {}
