...
/** @brief SPI transport for ESP-IDF (`driver/spi_master.h`).
 *
 ...
 * transport never touches a CS GPIO directly.
 *
 ...
 * `spi_device_handle_t` to construct the transport.
 *
 ...
 */
class SPITransportESPIDF : public Transport {
public:
    SPITransportESPIDF(spi_device_handle_t dev) : _dev(dev) {}
