 ...
 * connection instance represents one device on one I²C controller; the
 ...
 * matching the repeated-start contract every other I²C connection in this
 * repo provides.
 *
...
protected:
     ...
     *         connections (e.g. SMBus with PEC) can issue raw transfers
