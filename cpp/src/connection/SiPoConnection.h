...
/** @brief SiPo (serial-in/parallel-out shift register) connection for Arduino.
 *
...
public:
    SiPoConnection(SPIClass& spi, int rck_pin, int srclr_pin = -1, int g_pin = -1,
     ...
     *  @param g_pin      Pin number for G (output enable); -1 (default) disables it.
     */
    SiPoConnection(int ser_in_pin, int srck_pin, int rck_pin,
