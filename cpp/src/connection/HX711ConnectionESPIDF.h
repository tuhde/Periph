...
/** @brief HX711 GPIO bit-bang connection for ESP-IDF.
 *
 ...
 * the Arduino HX711 connection. There is no scheduler to yield to on
 ...
 *               (clock / power-down).
 */
class HX711ConnectionESPIDF {
public:
    HX711ConnectionESPIDF(gpio_num_t dout, gpio_num_t pd_sck)
