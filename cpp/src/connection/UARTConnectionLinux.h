...
/** @brief UART connection for Linux GCC (wraps POSIX termios / tcdrain).
 *
 ...
 *
 * For RS-485, the connection first tries kernel RS-485 mode via
...
public:
    UARTConnectionLinux(const char* path,
                        int baudrate    = 9600,
                        int data_bits   = 8,
                        int stop_bits   = 1,
                        char parity     = 'N',
