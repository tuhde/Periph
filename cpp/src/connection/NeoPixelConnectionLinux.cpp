...
NeoPixelConnectionLinux::~NeoPixelConnectionLinux() {
    if (_fd >= 0) close(_fd);
}

void NeoPixelConnectionLinux::_encode(const uint8_t* data, size_t len, uint8_t* out) {
...
void NeoPixelConnectionLinux::_write(const uint8_t* data, size_t len) {
