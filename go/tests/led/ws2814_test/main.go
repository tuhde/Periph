...
// WS2814 hardware test — Linux host.
//
// Opens /dev/spidevB.D and runs the WS2814 check sequence:
...
func main() {
	...
	if trErr != nil {
		...
		check("ws2814_minimal_skip_no_hw", true)
		check("ws2814_full_skip_no_hw", true)
