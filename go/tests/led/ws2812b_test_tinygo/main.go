...
// WS2812B hardware test — TinyGo / Raspberry Pi Pico W.
//
// Flashed to a Pico W with the WS2812B DIN on GP22. Runs the
// WS2812B check sequence: smoke tests for both Minimal and Full,
// fill, set_pixel, show, brightness scaling, rotation, and HSV
// fill. Prints PASS/FAIL per check and ends with the standard
// ===DONE: ... === line.
package main
