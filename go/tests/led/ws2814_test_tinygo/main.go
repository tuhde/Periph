...
// WS2814 hardware test — TinyGo / Raspberry Pi Pico W.
//
// Flashed to a Pico W with the WS2814 DIN on GP22. Runs the
// WS2814 check sequence: smoke tests for both Minimal and
...
func main() {
	...
	// --- WS2814Full ---
	{
		strip, err := led.NewWS2814Full(conn, 8) // Create WS2814 driver, (connection, n=8) → (*WS2814Full, error)
