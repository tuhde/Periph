...
// MPU9255 hardware test — TinyGo / Raspberry Pi Pico W.
//
// Flashed to a Pico W connected to an MPU9255 on I2C1 (GP4 = SDA,
...
func main() {
	...
	chip, err := imu.NewMPU9255Full(conn, magFactory)
	if err != nil {
