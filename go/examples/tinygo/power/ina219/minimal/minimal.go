...
// INA219 minimal example — TinyGo / Raspberry Pi Pico W.
//
...
func main() {
	...
	chip, err := power.NewINA219Minimal(conn, 0.1, 2.0)            // Create INA219 driver, (connection, r_shunt=0.1 Ω, max_current=2.0 A) → (*INA219Minimal, error)
	if err != nil {
		panic(err)
	}
