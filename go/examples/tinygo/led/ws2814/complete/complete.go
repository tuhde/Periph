...
// WS2814 complete example — TinyGo / Raspberry Pi Pico W.
//
// Wires the WS2814 DIN to GP22. Exercises every method in
// the WS2814Full API: pixel addressing, show, brightness,
...
func main() {
	...
	strip, err := led.NewWS2814Full(conn, n)                    // Create WS2814 driver, (connection, n=8) → (*WS2814Full, error)
	if err != nil {
		panic(err)
	}
