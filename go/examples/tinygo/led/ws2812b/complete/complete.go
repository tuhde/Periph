...
// WS2812B complete example — TinyGo / Raspberry Pi Pico W.
//
// Wires the WS2812B DIN to GP22. Exercises every method in the
// WS2812BFull API: pixel addressing, show, brightness, rotation,
// and HSV fill.
package main
