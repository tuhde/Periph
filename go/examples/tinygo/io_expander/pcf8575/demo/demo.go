...
// PCF8575 demo example — TinyGo / Raspberry Pi Pico W.
//
...
func main() {
	...
	chip, err := ioexpander.NewPCF8575Full(conn, 0x20)        // Create PCF8575 full driver, (connection, addr=0x20) → (*PCF8575Full, error)
	if err != nil {
		panic(err)
	}
