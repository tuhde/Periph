...
// LPS33HW complete example — Linux host.
//
// Exercises every method in the LPS33HWFull API: configuration, status,
// one-shot, FIFO, interrupt routing, AUTOZERO/AUTORIFP, soft reset, and
// reboot.
package main
