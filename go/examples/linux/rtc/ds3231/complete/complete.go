...
// DS3231 complete example — Linux host.
package main
...
func main() {
	...
	fmt.Printf("alarm1: s=%d m=%d h=%d d=%d mode=%d\n", a1Second, a1Minute, a1Hour, a1Day, a1Mode)
	fmt.Printf("interrupt_status=0x%02X 32khz=%v osf=%v aging=%d\n", status, enabled, stopped, offset)
	_ = time.Millisecond
}
