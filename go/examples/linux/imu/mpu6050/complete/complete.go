...
// MPU6050 complete example — Linux host.
//
// Exercises every method in the MPU6050Full API: identity verification,
// full-scale and DLPF configuration, temperature, raw readings,
// data-ready polling, sleep/standby, and FIFO management.
package main
...
func main() {
	...
	// 0=260/256 Hz, 1=184/188 Hz, 2=94/98 Hz, 3=44/42 Hz (default), 4=21/20, 5=10/10, 6=5/5
	...
	_ = chip // suppress unused warning if all set_sleep/standby are elided
}
