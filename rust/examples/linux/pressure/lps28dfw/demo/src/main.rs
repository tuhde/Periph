...
use periph::chips::pressure::{Lps28dfwFull, LPS28DFW_ODR_25_HZ, AVG_64, FS_MODE_1, LFPF_ODR_OVER_4};
...
fn main() {
    ...
    lps.configure(LPS28DFW_ODR_25_HZ, AVG_64, FS_MODE_1, true, LFPF_ODR_OVER_4).expect("configure");  // Configure chip, (odr=25 Hz, avg=64, fs_mode=1, lpf_en=true, lpf_cfg=ODR/4) → ()
    ...
    for n in 0..60 {
        ...
        let alt = 44330.0 * (1.0 - (p / 1013.25).powf(1.0 / 5.255));
