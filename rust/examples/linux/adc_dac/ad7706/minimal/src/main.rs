...
use periph::chips::adc_dac::{AD7706Minimal, MCLK_2_4576MHZ};
...
fn main() {
    ...
    let mut chip = AD7706Minimal::new(device, 2.5, MCLK_2_4576MHZ).expect("init AD7706");   // Create AD7706 driver, (spi, vref=2.5 V, mclk_hz=2_457_600 Hz) → Result
