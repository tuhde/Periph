...
use periph::chips::led::{Ws2814Minimal, Ws2814Full};

#[entry]
fn main() {
    let pins = esp_hal::gpio::Io::new();

    // --- Ws2814Minimal smoke test ---
    let spi = Spi::new(
    ...
    let mut strip = Ws2814Minimal::new(spi, 8);
    ...
    let mut full = Ws2814Full::new(spi2, 8);
