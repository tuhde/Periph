...
impl<I2C: I2c> Ina219Minimal<I2C> {
    ...
    pub fn shunt_voltage(&mut self) -> Result<f32, I2C::Error> {
        Ok(read_reg_signed(&mut self.i2c, self.addr, REG_SHUNT)? as f32 * 1e-5)
    }
...
pub const PGA_1: u8 = 0;
pub const PGA_2: u8 = 1;
pub const PGA_4: u8 = 2;
pub const PGA_8: u8 = 3;

pub const BRNG_16V: u8 = 0;
pub const BRNG_32V: u8 = 1;

pub const ADC_9BIT: u8 = 0;
pub const ADC_10BIT: u8 = 1;
pub const ADC_11BIT: u8 = 2;
pub const ADC_12BIT: u8 = 3;
pub const ADC_AVG_2: u8 = 8;
pub const ADC_AVG_4: u8 = 9;
pub const ADC_AVG_8: u8 = 10;
pub const ADC_AVG_16: u8 = 11;
pub const ADC_AVG_32: u8 = 12;
pub const ADC_AVG_64: u8 = 13;
pub const ADC_AVG_128: u8 = 14;
...
impl<I2C: I2c> Ina219Full<I2C> {
    pub fn new(i2c: I2C, addr: u8, r_shunt: f32, max_current: f32) -> Result<Self, I2C::Error> {
        ...
        Ok(Self { inner, mode: 7, saved_config: CONFIG_DEFAULT })
    }
    ...
    pub fn reset(&mut self) -> Result<(), I2C::Error> {
        ...
        write_reg(&mut self.inner.i2c, self.inner.addr, REG_CAL, self.inner.cal)?;
        write_reg(&mut self.inner.i2c, self.inner.addr, REG_CONFIG, self.saved_config)
    }
