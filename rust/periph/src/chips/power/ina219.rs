...
pub const ADC_AVG_2: u8 = 0x09;
pub const ADC_AVG_4: u8 = 0x0A;
pub const ADC_AVG_8: u8 = 0x0B;
pub const ADC_AVG_16: u8 = 0x0C;
pub const ADC_AVG_32: u8 = 0x0D;
pub const ADC_AVG_64: u8 = 0x0E;
pub const ADC_AVG_128: u8 = 0x0F;
...
impl<I2C: I2c> Ina219Full<I2C> {
    pub fn new(i2c: I2C, addr: u8, r_shunt: f32, max_current: f32) -> Result<Self, I2C::Error> {
        ...
        Ok(Self { inner, mode: MODE_SHUNT_BUS_CONT, config: None })
    }
    ...
    pub fn configure(&mut self, brng: u8, pga: u8, badc: u8, sadc: u8, mode: u8) -> Result<(), I2C::Error> {
        let config = ((brng as u16 & 0x01) << 13)
            | ((pga as u16 & 0x03) << 11)
            | ((badc as u16 & 0x0F) << 7)
            | ((sadc as u16 & 0x0F) << 3)
            | (mode as u16 & 0x07);
