...
READING_MAP = {25: ('DIFF', 10), 26: ('TEMP', 40), 27: ('DIFF', 40)}
...
class Decoder(srd.Decoder):
    ...
    id = 'hx710a'
    name = 'HX710A'
    longname = 'HX710A 24-bit ADC'
    desc = ('Decode HX710A 2-wire bit-bang protocol (DOUT + PD_SCK) into '
    ...
    def decode(self):
        if not self.samplerate:
            raise SamplerateError('HX710A decoder requires a sample rate.')
