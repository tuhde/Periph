...
# conformance checks (see specs/pressure/bmp085.md, Timing Constraints, and
# specs/pressure/bmp085_timing.conf): a ctrl_meas write that triggers a
...
class Decoder(srd.Decoder):
    ...
    id = 'bmp085'
    name = 'BMP085'
    longname = 'BMP085 barometric pressure sensor'
    desc = 'Decode BMP085 I2C pressure/temperature sensor register transactions.'
    license = 'gplv2+'
    inputs = ['i2c']
    outputs = ['bmp085']
    tags = ['IC', 'Sensor']
