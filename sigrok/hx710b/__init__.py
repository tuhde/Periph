"""
HX710B 24-bit ADC sigrok protocol decoder.

Decodes the custom 2-wire bit-bang protocol (DOUT + PD_SCK) — the same
wire-level format as the HX711 — into annotated conversions. The HX710B
...
(differential input or DVDD−AVDD supply-difference) and an output rate:
...
Pulse count -> reading type/rate for the NEXT conversion:
  ...
  26 pulses -> Supply-difference, 40 Hz
