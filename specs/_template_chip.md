...
- [ ] Examples `cpp/examples/zephyr/<category>/<Chip>/minimal/main.cpp` — Tier-1
- [ ] Examples `cpp/examples/zephyr/<category>/<Chip>/complete/main.cpp` — Tier-1 + Tier-2
- [ ] Examples `cpp/examples/zephyr/<category>/<Chip>/demo/main.cpp` — Tier-1 + Tier-3
- [ ] Examples `cpp/examples/espidf/<category>/<Chip>/minimal/main/main.cpp` — Tier-1
- [ ] Examples `cpp/examples/espidf/<category>/<Chip>/complete/main/main.cpp` — Tier-1 + Tier-2
- [ ] Examples `cpp/examples/espidf/<category>/<Chip>/demo/main/main.cpp` — Tier-1 + Tier-3
- [ ] Examples `cpp/examples/picosdk/<category>/<Chip>/minimal/src/main.cpp` — Tier-1
- [ ] Examples `cpp/examples/picosdk/<category>/<Chip>/complete/src/main.cpp` — Tier-1 + Tier-2
- [ ] Examples `cpp/examples/picosdk/<category>/<Chip>/demo/src/main.cpp` — Tier-1 + Tier-3
...
- [ ] Tests `cpp/tests/<category>/<chip>_test_espidf/main/main.cpp` (ESP-IDF)
- [ ] Tests `cpp/tests/<category>/<chip>_test_picosdk/src/main.cpp` (Pico SDK)
...
- [ ] Examples `rust/examples/linux/<category>/<chip>/minimal/src/main.rs` — Tier-1
- [ ] Examples `rust/examples/linux/<category>/<chip>/complete/src/main.rs` — Tier-1 + Tier-2
- [ ] Examples `rust/examples/linux/<category>/<chip>/demo/src/main.rs` — Tier-1 + Tier-3
